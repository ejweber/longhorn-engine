...
func (t *Task) FetchBackupStatus(backupID string, replicaAddr string) (*BackupStatusInfo, error) {
	repClient, err := replicaClient.NewReplicaClient(replicaAddr, t.volumeName, "") // TODO
	if err != nil {
...
func (t *Task) Reset() error {
	...
	for _, replica := range replicas {
		repClient, err := replicaClient.NewReplicaClient(replica.Address, t.volumeName, "") // TODO
		if err != nil {
