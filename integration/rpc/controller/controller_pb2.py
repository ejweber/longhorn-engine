...
_VERSIONOUTPUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cliAPIMinorVersion', full_name='ptypes.VersionOutput.cliAPIMinorVersion', index=9,
